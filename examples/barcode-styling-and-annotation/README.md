...
The code snippets towards the end illustrate how, by using fluent style syntax akin to `System.Linq`, one can efficiently generate and style a barcode in just a few lines.